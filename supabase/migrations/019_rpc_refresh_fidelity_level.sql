-- Função exigida por rpc_solicitar_sms_v3 (e webhooks). Idempotente.
-- Se a migração 012 nunca foi aplicada no projecto, este ficheiro corrige o erro:
--   function public.rpc_refresh_fidelity_level(uuid) does not exist
