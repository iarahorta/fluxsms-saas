-- 025: rpc_solicitar e rpc_get_service_stocks — chips com status on/online/active entram
-- (o admin mostra "Chips ON" com esses estados; antes a RPC só aceitava 'idle' no WhatsApp e falhava com sem_chips)
