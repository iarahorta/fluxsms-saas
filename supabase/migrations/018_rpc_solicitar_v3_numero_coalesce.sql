-- Resposta JSON do rpc_solicitar_sms_v3: campo `numero` alinhado ao phone_number gravado na ativação
-- (evita null no cliente quando o chip ainda não tem MSISDN).
